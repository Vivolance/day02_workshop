...
public class BankAccount {
    //anything with final does not have a getter, only a setter
    ...
    public void deposit (double amount) {
        ...
        if (!isActive) {
            throw new IllegalArgumentException("You cannot make dpeosit to a close account");
    ...
    public void withdraw (double amount) {
        ...
        if (!isActive) {
            throw new IllegalArgumentException("You cannot make withdrawal out of a close account");
